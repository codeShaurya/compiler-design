...
{
  "$end", "error", "$undefined", "id", "plus", "minus", "mul", "divide",
  "op", "cl", "ln", "$accept", "line", "E", YY_NULLPTR
};
#endif
...
#line 18 "calc.y" /* yacc.c:1646  */
    {(yyval)=(yyvsp[-2])+(yyvsp[0]);printf("plus\n");}
#line 1220 "y.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 19 "calc.y" /* yacc.c:1646  */
    {(yyval)=(yyvsp[-2])-(yyvsp[0]);printf("minus\n");}
...
#line 23 "calc.y" /* yacc.c:1646  */
    {(yyval)=-(yyvsp[0]);printf("minus\n");}
#line 1250 "y.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 24 "calc.y" /* yacc.c:1646  */
    {(yyval)=atoi(yytext);printf("digit=%d\n",atoi(yytext));}
